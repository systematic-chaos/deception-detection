...
n <- 1000
lang <- 'ar'
path_training <- "deception/training/APDA@FIRE.Qatar-News-corpus.training.20190524.csv"
path_test <- "deception/test/APDA@FIRE.Qatar-News-corpus.test.20190608.csv"
k <- 4
r <- 1
