...
# Check and adjust predicte classes based on prediction probabilities
# and density probability distribution for every class
#pred_SVM.class <- as.data.frame(apply(pred_SVM, 1, distributeProbabilisticPrediction, classes, class_probs), stringsAsFactors=TRUE)
